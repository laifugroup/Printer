...
//        this.setVerticalAlignment(VerticalAlignment.MIDDLE)
    ...
    val image =  Image(ImageDataFactory.create("C:\\Users\\leyuan\\IdeaProjects\\Printer\\src\\main\\resources\\webwxgetmsgimg.jpg"));
    image.setWidth(128f)
    image.setHeight(128f)
    image.setOpacity(0.8f)
    image.setFixedPosition(1,1f,1f)
    //dvFu.add(image)
